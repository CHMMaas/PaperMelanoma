...
for (data.type in c("training", "validation")){
  for (outcome in c("Rec.5", "MSM.5")){
    ...
    PredictionTools::val.surv.mi(p, S,
                                 g=5,main="All patients", time=NULL,lim=c(0,1),dist=TRUE)
    grDevices::dev.off()
    ...
    PredictionTools::val.surv.mi(p[data$SNstatus=="Positive",],
                                 ...
                                 g=5,main="Patients with positive SN", time=NULL,lim=c(0,1),dist=TRUE)
    grDevices::dev.off()
    ...
    PredictionTools::val.surv.mi(p[data$SNstatus=="Negative",],
                                 ...
                                 g=5,main="Patients with negative SN", time=NULL,lim=c(0,1),dist=TRUE)
    grDevices::dev.off()
