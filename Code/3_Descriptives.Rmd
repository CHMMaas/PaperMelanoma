...
Rec.MSM.table <- function(horizon=5, type=NULL, data.to.be.imputed=NULL){
  ...
  RFS.all <- 100*SF.Rec.all$surv[SF.Rec.all$time==max(SF.Rec.all$time[SF.Rec.all$time<=horizon])]
  ...
  RFS.neg <- 100*SF.Rec.neg$surv[SF.Rec.neg$time==max(SF.Rec.neg$time[SF.Rec.neg$time<=horizon])]
  ...
  RFS.pos <- 100*SF.Rec.pos$surv[SF.Rec.pos$time==max(SF.Rec.pos$time[SF.Rec.pos$time<=horizon])]
  ...
  MSS.all <- 100*SF.MSM.all$surv[SF.MSM.all$time==max(SF.MSM.all$time[SF.MSM.all$time<=horizon])]
  ...
  MSS.neg <- 100*SF.MSM.neg$surv[SF.MSM.neg$time==max(SF.MSM.neg$time[SF.MSM.neg$time<=horizon])]
  ...
  MSS.pos <- 100*SF.MSM.pos$surv[SF.MSM.pos$time==max(SF.MSM.pos$time[SF.MSM.pos$time<=horizon])]
  ...
  Rec.MSM.table <- data.frame(n=c(nrow(data.to.be.imputed),
                              ...
                              e2=rep("", 3),
                              RFS=sprintf("%.1f", c(RFS.all, RFS.neg, RFS.pos)),
                              MSS=sprintf("%.1f", c(MSS.all, MSS.neg, MSS.pos)))
