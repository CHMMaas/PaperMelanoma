...
# Plot calibration of all centers combined and all centers seperate for recurrence and melanoma specific mortality refit and write results to Excel
```{r, eval=TRUE}
horizon <- 5
...
# save tables
write.table(final.full.table.Rec,file='Z:/Project Melanoom/PaperMelanoma/Results/final.full.table.Rec.txt')
write.table(final.full.table.MSM.refit,file='Z:/Project Melanoom/PaperMelanoma/Results/final.full.table.MSM.refit.txt')
write.table(final.BS.table.Rec,file='Z:/Project Melanoom/PaperMelanoma/Results/final.BS.table.Rec.txt')
write.table(final.BS.table.MSM,file='Z:/Project Melanoom/PaperMelanoma/Results/final.BS.table.MSM.txt')
write.table(final.BS.table.MSM.refit,file='Z:/Project Melanoom/PaperMelanoma/Results/final.BS.table.MSM.refit.txt')
