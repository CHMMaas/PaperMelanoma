...
calculate.AJCC.7.8 <- function(imputed.data=NULL, type=NULL, S.Rec.5=NULL){
  ...
  for (i in 1:m){
    ...
    # Uno's c-index  
    unoC.AJCC.7[i] <- survC1::Est.Cval(mydata=cbind(S.Rec.5[, 1], S.Rec.5[, 2], 
                                              AJCC.7.i), 
                                 tau=5, nofit=TRUE)$Dhat

    # compute C-index for only positive sentinel node patients
    positives <- imputation.i$SNstatus=="Positive"
    rc.pos <- Hmisc::rcorr.cens(-AJCC.7.i[positives], S.Rec.5[positives,])
    cindex.AJCC.7.pos[i]<-rc.pos["C Index"]
    cindex.AJCC.7.se.pos[i]<-rc.pos["S.D."]/2
    
    # Uno's c-index  
    unoC.AJCC.7.pos[i] <- survC1::Est.Cval(mydata=cbind(S.Rec.5[positives, 1], 
                                              S.Rec.5[positives, 2], 
                                              AJCC.7.i[positives]), 
                                 tau=5, nofit=TRUE)$Dhat
  
    # compute C-index for only negative sentinel node patients
    negatives <- imputation.i$SNstatus=="Negative"
    rc.neg <- Hmisc::rcorr.cens(-AJCC.7.i[negatives], S.Rec.5[negatives,])
    cindex.AJCC.7.neg[i]<-rc.neg["C Index"]
    cindex.AJCC.7.se.neg[i]<-rc.neg["S.D."]/2
    
    # Uno's c-index  
    unoC.AJCC.7.neg[i] <- survC1::Est.Cval(mydata=cbind(S.Rec.5[negatives, 1], 
                                              S.Rec.5[negatives, 2], 
                                              AJCC.7.i[negatives]), 
                                 tau=5, nofit=TRUE)$Dhat
  }
  ...
  AJCC.7.table <- rbind(c("All patients:", sprintf("%.2f", cindex.mi.AJCC.7$est),
              ...
              c("Positive SN patients:", sprintf("%.2f", cindex.mi.AJCC.7.pos$est),
                ...
                sprintf("%.2f", mean(unoC.AJCC.7.pos))),
              c("Negative SN patients:", sprintf("%.2f", cindex.mi.AJCC.7.neg$est),
                ...
                sprintf("%.2f", mean(unoC.AJCC.7.neg))))
  ...
  for (i in 1:m){
    ...
    # Uno's c-index  
    unoC.AJCC.8[i] <- survC1::Est.Cval(mydata=cbind(S.Rec.5[, 1], S.Rec.5[, 2], 
                                              AJCC.8.i), 
                                 tau=5, nofit=TRUE)$Dhat
  
    # compute C-index for only positive sentinel node patients
    positives <- imputation.i$SNstatus=="Positive"
    rc.pos <- Hmisc::rcorr.cens(-AJCC.8.i[positives], S.Rec.5[positives,])
    cindex.AJCC.8.pos[i]<-rc.pos["C Index"]
    cindex.AJCC.8.se.pos[i]<-rc.pos["S.D."]/2
    unoC.AJCC.8.pos[i] <- survC1::Est.Cval(mydata=cbind(S.Rec.5[positives, 1], 
                                                    S.Rec.5[positives, 2], 
                                                    AJCC.8.i[positives]), 
                                 tau=5, nofit=TRUE)$Dhat
    ...
    # compute C-index for only negative sentinel node patients
    negatives <- imputation.i$SNstatus=="Negative"
    rc.neg <- Hmisc::rcorr.cens(-AJCC.8.i[negatives], S.Rec.5[negatives,])
    cindex.AJCC.8.neg[i]<-rc.neg["C Index"]
    cindex.AJCC.8.se.neg[i]<-rc.neg["S.D."]/2
    unoC.AJCC.8.neg[i] <- survC1::Est.Cval(mydata=cbind(S.Rec.5[negatives, 1], 
                                                    S.Rec.5[negatives, 2], 
                                                    AJCC.8.i[negatives]), 
                                 tau=5, nofit=TRUE)$Dhat
  ...
  AJCC.8.table <- rbind(c("All patients:", sprintf("%.2f", cindex.mi.AJCC.8$est),
                    ...
                    c("Positive SN patients:", sprintf("%.2f", cindex.mi.AJCC.8.pos$est),
                      ...
                      sprintf("%.2f", mean(unoC.AJCC.8.pos))),
                    c("Negative SN patients", sprintf("%.2f", cindex.mi.AJCC.8.neg$est),
                      ...
                      sprintf("%.2f", mean(unoC.AJCC.8.neg))))
...
utils::write.table(cbind(CIndex.val,
                   validation.AJCC$AJCC.7.table[, -1],
                   compare.AJCC.model[, 2:3],
                   validation.AJCC$AJCC.8.table[,-1],
